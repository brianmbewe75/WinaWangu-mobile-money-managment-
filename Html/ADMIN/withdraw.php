    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="withdraw.php" class="active"><span class="la la-bank"></span><span>Withdraw</span></a>
                </li>
                <li>
...
<div class="container">
   ...
   <div class="input-box">
       ...
       <input type="text" placeholder="Enter amount"  name="amount"  id="amount" value="<?php echo $_POST['amount'];?>">
       
       </div>
    
                       <div class="input-box">
                           <span class="details">Phone number</span>
                           <input type="text" placeholder="Enter reciepients number" id="number"  name="number" value="<?php echo $_POST['number'];?>">
                         
                           </div>

                           <div class="input-box">
                            <span>Location</span>
                            <select  name="location" id="Location" value="<?php echo $_POST['location'];?>">
                           ...
                           <div class="input-box">
                            <span>Booth</span>
                            <select  typr="text" name="booth" id="Booth"value="<?php echo $_POST['booth'];?>">
                        ...
                        <div class="input-box">
                            ...
                            <select id="Service" name="service" value="<?php echo $_POST['service'];?>">
